"""Crear conexion con la tabla de reservas."""
...
def agregar_reserva(
    ...
    sql = """
        INSERT INTO data_reservas (id_prestador, razon_social, nit, administrador, ubicacion, tipo_servicio, 
        imagen, id_usuario, nombre_cliente, telefono_cliente, correo_cliente, hora_reserva, fecha_reserva) 
...
def obtener_reservas_realizadas(id_usuario):
    """Obtener las reservas realizadas por un usuario especifico."""

    conexion = crear_conexion()
    cursor = conexion.cursor()
    sql = """
        SELECT razon_social, nit, administrador, ubicacion, tipo_servicio, imagen, 
        nombre_cliente, telefono_cliente, correo_cliente, hora_reserva, fecha_reserva, id_usuario 
        FROM data_reservas WHERE id_usuario = %s
    """
...
def obtener_reservas(id_prestador):
    """Obtener las reservas realizadas a un prestador de servicios especifico."""

    conexion = crear_conexion()
    cursor = conexion.cursor()
    sql = """
        SELECT razon_social, nit, administrador, ubicacion, tipo_servicio, 
        imagen, id_usuario, nombre_cliente, telefono_cliente, correo_cliente, hora_reserva, fecha_reserva 
        FROM data_reservas WHERE id_prestador = %s
    """
...
def seguro_descifrar(valor):
    """Funcion para descifrar datos de forma segura."""
...
def eliminar_reserva(id_usuario):
    """Eliminar reservas de un usaurio especifico."""
