...
class Registro_Screen(MDScreen):
    """Clase principla de la pantalla opciones de registro."""
    ...
    def registro_usuario(self, instance):
        """Navegacion a la pantalla de registro de cliente"""

        self.manager.current = "registrousuarioscreen"

    def registro_servicio(self, instance):
        """Navegacion a la pantalla de registro de prestador de servicio."""
